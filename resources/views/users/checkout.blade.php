    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
        	...
        	<input type="text" class="form-control font-weight-light" id="address_one" aria-describedby="emailHelp" placeholder="House #2B, Road #08, Nikunja-2, Khilkhet, Dhaka 1229">
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
